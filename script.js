document.addEventListener('DOMContentLoaded', () => {
    ...
    const detailMoreBtnWrap = document.getElementById('detailMoreBtnWrap');
    
    if (detailMoreBtn && detailContentWrap && detailMoreBtnWrap) {
        detailMoreBtn.addEventListener('click', () => {
            detailContentWrap.classList.add('expanded');
            detailMoreBtnWrap.style.display = 'none'; // 버튼 사라짐
        });
    }
